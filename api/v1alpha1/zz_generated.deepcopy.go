...
func (in *FlinkClusterSpec) DeepCopyInto(out *FlinkClusterSpec) {
	*out = *in
	...
	if in.PostJobPolicy != nil {
		in, out := &in.PostJobPolicy, &out.PostJobPolicy
		*out = new(PostJobPolicy)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PostJobPolicy) DeepCopyInto(out *PostJobPolicy) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PostJobPolicy.
func (in *PostJobPolicy) DeepCopy() *PostJobPolicy {
	if in == nil {
		return nil
	}
	out := new(PostJobPolicy)
