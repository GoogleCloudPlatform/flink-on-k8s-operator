...
To execute the install scripts, you'll also need [kustomize](https://github.com/kubernetes-sigs/kustomize/blob/master/docs/INSTALL.md) and [go](https://golang.org/doc/install) installed on your local machine
